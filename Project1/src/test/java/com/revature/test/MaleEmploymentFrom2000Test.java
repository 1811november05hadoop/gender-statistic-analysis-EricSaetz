...
public class MaleEmploymentFrom2000Test {
	...
	@Before
	public void setUp() {
		MaleEmploymentFrom2000 mapper = new MaleEmploymentFrom2000();
	...
	public void testFemaleEmploymentFrom2000Mapper() {
		mapDriver.withInput(new LongWritable(1),new Text("\"India\",\"IND\",\"Employment to population ratio, 15+, male (%) "
		...
		mapDriver.withOutput(new Text("India : Employment to population ratio, 15+, male (%) (modeled ILO estimate)"),
	...
	public void testChangeInEmploymentReducer() {
    	...
    	reduceDriver.withInput(new Text("India : Employment to population ratio, 15+, male (%) (modeled ILO estimate)")
    			, values);
    	reduceDriver.withOutput(new Text("India : Employment to population ratio, 15+, male (%) (modeled ILO estimate): (2000,2001)")
	...
	public void testChangeInEmploymentMapReducer() {
		mapReduceDriver.withInput(new LongWritable(1),new Text("\"India\",\"IND\",\"Employment to population ratio, 15+, male (%) "
				+ "(modeled ILO estimate)\",\"SL.EMP.TOTL.SP.FE.ZS\",\"\",\"\",\"\",\"\",\"\",\"\""
				+ ",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\""
				+ ",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"33.4739990234375\",\"33.7470016479492\""
				+ ",\"34.0029983520508\",\"34.3160018920898\",\"33.9570007324219\",\"33.6539993286133\""
		...
		mapReduceDriver.withOutput(new Text("India : Employment to population ratio, 15+, male (%) (modeled ILO estimate): (2000,2016)")
    			, new Text(-6.508998870849602+""));
